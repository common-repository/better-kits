<?php
/**
 * Class BetterKits\FullWidthTemplates\Elementor
 *
 * @package     BetterKits\FullWidthTemplates\Elementor
 * @copyright   Copyright (c) 2021, Smart Innovates
 * @license     http://opensource.org/licenses/gpl-2.0.php GNU Public License
 * @since       1.0.0
 */

namespace BetterKits\FullWidthTemplates;
...
class Elementor {
	...
	public function __clone() {
		...
		_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'better-kits' ), '1.0.0' );
	}
